...
public class Ed25519Test {
	...
	@Test(dataProvider = "sign", dependsOnGroups= {"basics","bigpoint","hash"}, dependsOnMethods = {"ed25519.test.internal.CurveTest.testScalarMult","ed25519.test.internal.CurveTest.testEncodePoint","ed25519.test.internal.ConstantsTest.testGetBitLength"})
